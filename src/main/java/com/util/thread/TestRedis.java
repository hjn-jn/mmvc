...
////        ThreadTest test = new ThreadTest("threadTest");
////        test.start();
////        for (int i = 0;i<10 ; i++)
////        {
...
////        }
////        try {
////            test.join();//等待ThreadTest类子线程完成 ，不加就直接跑下面的sys.out了
////            System.out.println(test.getResult());
////        } catch (InterruptedException e) {
////            e.printStackTrace();
////        }
//
////        RunnableTest test = new RunnableTest("runnable");
////        test.run();
//
//        Long start = System.currentTimeMillis();
//        ExecutorService exs = Executors.newFixedThreadPool(200);
//        try {
...
//                Date d = df.parse("20180101");
//
//                //System.out.println("今天的日期："+df.format(d));
//                String dv = df.format(new Date(d.getTime() + i * 24 * 60 * 60 * 1000));
//
//                futureList.add(exs.submit(new CallableTest(dv,"tot_amt_actual")));
//            }
//            Long getResultStart = System.currentTimeMillis();
//
//            for(Future<Object> future : futureList) {
//                String i = future.get().toString();
//                db = db.add(new BigDecimal(i));
//                System.out.println("任务"+Thread.currentThread().getName()+"获取完成!"+ i);
//                list.add(i);
//            }
